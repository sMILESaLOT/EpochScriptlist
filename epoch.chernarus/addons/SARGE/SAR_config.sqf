...
SAR_DETECT_HOSTILE_FROM_VEHICLE = 250;
...
// bandit AI
SAR_leader_band_list = ["TK_INS_Warlord_EP1_DZ"]; // the potential classes of the leader of a bandit group
SAR_sniper_band_list = ["CZ_Soldier_Sniper_EP1_DZ"]; // the potential classes of the snipers of a bandit group
SAR_soldier_band_list = ["Ins_Soldier_GL_DZ"]; // the potential classes of the riflemen of a bandit group
...
SAR_sold_leader_weapon_list = ["M4A3_CCO_EP1","m8_holo_sd"];
SAR_sold_leader_pistol_list = [];   

// potential item list for leaders -> Item / Chance 1 - 100
SAR_sold_leader_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["ItemGoldBar",75]];
...
SAR_sold_rifleman_weapon_list = ["M16A2","M1014","M4A1"];
SAR_sold_rifleman_pistol_list = [];    

// potential item list for riflemen
SAR_sold_rifleman_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["ItemSilverBar10oz,75]];
...
SAR_sold_sniper_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["Skin_Sniper1_DZ",10],["ItemSilveBar10oz,75]];
...
// potential item list for leaders -> Item / Chance 1 - 100
SAR_surv_leader_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["ItemGoldBar",75]];
...
// potential item list for riflemen
SAR_surv_rifleman_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["ItemSilverBar10oz,75]];
...
// potential item list for snipers
SAR_surv_sniper_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["ItemSilverBar10oz,75]];
...
// potential weapon list for leaders
SAR_band_leader_weapon_list = ["AKS_74_kobra","M4A3_CCO_EP1","AK_47_M","Sa58V_CCO_EP1"];
SAR_band_leader_pistol_list = [];   

// potential item list for leaders -> Item / Chance 1 - 100
SAR_band_leader_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["ItemGoldBar",75]];
SAR_band_leader_tools =  [["ItemMap",50],["ItemCompass",30],["Binocular_Vector",5],["NVGoggles",5],["ItemRadio",100]];

//potential weapon list for riflemen
SAR_band_rifleman_weapon_list = ["AK_74","M1014","Sa58P_EP1"];
SAR_band_rifleman_pistol_list = [];    

// potential item list for riflemen
SAR_band_rifleman_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["ItemSilverBar10oz,75]];
...
// potential item list for snipers
SAR_band_sniper_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["ItemSilverBar10oz,75]];
